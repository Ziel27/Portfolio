...
const About = () => {
          ...
          <div className="absolute inset-0">
            ...
            >
              ...
              <rect
                width="100%"
                height="100%"
                fill="url(#winterSky-about)"
                className="dark:fill-[url(#winterSkyDark-about)]"
              />
              <path
          ...
          <div className="absolute inset-0">
            ...
            >
              ...
              <rect
                width="100%"
                height="100%"
                fill="url(#springSky-about)"
                className="dark:fill-[url(#springSkyDark-about)]"
              />
              <path
          ...
          <div className="absolute inset-0">
            ...
            >
              ...
              <rect
                width="100%"
                height="100%"
                fill="url(#summerSky-about)"
                className="dark:fill-[url(#summerSkyDark-about)]"
              />
              <circle
                cx="320"
                cy="80"
          ...
          <div className="absolute inset-0">
            ...
            >
              ...
              <rect
                width="100%"
                height="100%"
                fill="url(#fallSky-about)"
                className="dark:fill-[url(#fallSkyDark-about)]"
              />
              <path
  ...
  const techStack = {
    ...
    devops: ["AWS", "Docker", "Git", "CI/CD", "AWS AIOps"],
  };
  ...
  const experience = [
    {
      ...
      description:
        "Building scalable web applications and providing freelance services to clients worldwide.",
    },
    {
      year: "2021 - 2024",
      title: "Full Stack Developer",
      description:
        "Developed end-to-end solutions with React, Node.js, and modern development practices.",
    },
    {
      year: "2020",
      title: "Hello World!",
