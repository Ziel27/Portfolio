...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact - Gian Daziel Pon | Get In Touch</title>
        <meta
          name="description"
          content="Get in touch with Gian Daziel Pon for freelance projects, collaborations, and open-source contributions. Available for web development projects."
        />
        <meta
          property="og:title"
          content="Contact - Gian Daziel Pon | Get In Touch"
        />
        <meta
          property="og:description"
          content="Get in touch for freelance projects, collaborations, and open-source contributions."
        />
        <meta
          property="og:url"
          content="https://giandazielpon.online/contact"
        />
        <link rel="canonical" href="https://giandazielpon.online/contact" />
      </Helmet>
